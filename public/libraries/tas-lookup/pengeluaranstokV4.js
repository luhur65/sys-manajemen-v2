...
if (typeof pengeluaranstokLookupType !== 'undefined' && typeof pengeluaranstokLookupData !== 'undefined') {
    typeData = pengeluaranstokLookupType;
    filtersData = pengeluaranstokLookupData;
} else {
    typeData = 'JSON'
}
...
filterPostData = {
    ...
    // roleInput: parsePostData.roleInput || '',
    roleinput: parsePostData.roleInput || '',
    isLookup: parsePostData.isLookup || '',
    forLookup: true,
    isLookup2: parsePostData.isLookup2 || true,
    tipeData: typeData
};

urlRequestGrid =  `${apiUrl}pengeluaranstok`;
