...
if (typeof supplierLookupType !== 'undefined' && typeof supplierLookupData !== 'undefined') {
    typeData = supplierLookupType;
    filtersData = supplierLookupData;
} else {
    typeData = 'JSON'
}
...
urlRequestGrid =  `${apiUrl}supplier`;
