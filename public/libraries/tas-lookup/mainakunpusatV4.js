...
if (typeof mainakunpusatLookupType !== 'undefined' && typeof mainakunpusatLookupData !== 'undefined') {
    typeData = mainakunpusatLookupType;
    filtersData = mainakunpusatLookupData; 
} else {
    typeData = 'JSON';
}
