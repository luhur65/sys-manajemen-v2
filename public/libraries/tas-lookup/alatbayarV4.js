...
if (typeof alatbayarLookupType !== 'undefined' && typeof alatbayarLookupData !== 'undefined') {
    typeData = alatbayarLookupType;
    filtersData = alatbayarLookupData;
        
    if (parsePostData.bank_Id && parsePostData.bank_tipe && !parsePostData.from) {
        result = filtersData.filter((word) => word.tipebank === parsePostData.bank_tipe);
    } else {
        result = filtersData
    }
...
urlRequestGrid =  `${apiUrl}alatbayar`;
