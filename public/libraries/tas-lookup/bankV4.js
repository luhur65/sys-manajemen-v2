...
if (typeof bankLookupType !== 'undefined' && typeof bankLookupData !== 'undefined') {
    typeData = bankLookupType;
    filtersData = bankLookupData;

    if (parsePostData.bankExclude !== undefined) {
        result = filtersData.filter((word) => word.id !== parsePostData.bankExclude);
    } else if (parsePostData.alatbayar && parsePostData.bank_tipe !== undefined) {
        result = filtersData.filter((word) => word.tipe === parsePostData.bank_tipe);
    } else {
        result = filtersData
    }
...
// var filtersData = bankLookupData;
