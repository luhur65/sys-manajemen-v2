...
if (typeof jenisbiayaLookupType !== 'undefined' && typeof jenisbiayaLookupData !== 'undefined') {
    typeData = jenisbiayaLookupType;
    filtersData = jenisbiayaLookupData;    
} else {    
    typeData = 'JSON'
}
...
urlRequestGrid = `${apiUrl}jenisbiaya`                           
