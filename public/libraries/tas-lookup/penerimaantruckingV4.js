...
if (typeof penerimaantruckingLookupType !== 'undefined' && typeof penerimaantruckingLookupData !== 'undefined') {
    typeData = penerimaantruckingLookupType;
    filtersData = penerimaantruckingLookupData;
} else {
    typeData = 'JSON'
}
...
urlRequestGrid =  `${apiUrl}penerimaantrucking`;
