...
if (typeof cabangLookupType !== 'undefined' && typeof cabangLookupData !== 'undefined') {
    typeData = cabangLookupType;
    filtersData = cabangLookupData;
} else {
    typeData = 'JSON'
}
...
filterPostData = {
    ...
    emkl: parsePostData.emkl  || '',
    transferCoa: parsePostData.transferCoa  || '',
    isLookup: parsePostData.isLookup || true,
    tipeData: typeData
};

urlRequestGrid =  `${apiUrl}cabang`;
