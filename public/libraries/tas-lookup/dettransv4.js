...
if (
    typeof detTransType !== "undefined" &&
    typeof dettransLookupData !== "undefined"
) {
    typeData = detTransType;
    filtersData = dettransLookupData;
...
// var filtersData = dettransLookupData;

urlRequestGrid = `${apiUrl}dettrans`;
