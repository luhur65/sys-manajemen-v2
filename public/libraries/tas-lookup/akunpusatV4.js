...
if (typeof akunpusatLookupType !== 'undefined' && typeof akunpusatLookupData !== 'undefined' ) {
    typeData = akunpusatLookupType
    filtersData = akunpusatLookupData
    
    if (parsePostData.bank && parsePostData.bank.includes('PENGEMBALIAN')) {
        result = filtersData.filter((word) => word.keterangancoa == "KANTOR PUSAT");
    } else {
        result = filtersData
    }
} else {
...
// typeData = akunpusatLookupType
filterPostData = {
    levelCoa: parsePostData.levelCoa || '',
    potongan: parsePostData.potongan || '',
    aktif: parsePostData.Aktif || '',
    keterangancoa: parsePostData.KeteranganCoa || '',
    supplier: parsePostData.Supplier || '',
    coasparepart: parsePostData.coasparepart || false,
    isParent: parsePostData.isParent || '',
    manual: parsePostData.manual || '',
    bank: parsePostData.bank || '',
    forHutang: parsePostData.forHutang || false,
    isLookup: parsePostData.isLookup || "",
    tipeData: typeData,
    equalField: "keterangancoa",
};

// var filtersData = akunpusatLookupData

urlRequestGrid = `${apiUrl}akunpusat`;
