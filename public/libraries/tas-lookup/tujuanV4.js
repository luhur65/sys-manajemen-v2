...
if (typeof tujuanLookupType !== 'undefined' && typeof tujuanLookupData !== 'undefined') {
    typeData = tujuanLookupType;
    filtersData = tujuanLookupData;
} else {
    typeData = 'JSON'
}
