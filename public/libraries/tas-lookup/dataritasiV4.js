...
if (typeof dataritasiLookupType !== 'undefined' && typeof dataritasiLookupData !== 'undefined') {
    typeData = dataritasiLookupType;
    filtersData = dataritasiLookupData;
} else {
    typeData = 'JSON'
}
...
urlRequestGrid= `${apiUrl}dataritasi`,
