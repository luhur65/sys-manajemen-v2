...
width = ''
// use this width if single column lookup
...
if (typeof marketingLookupType !== 'undefined' && typeof marketingLookupData !== 'undefined') {
    typeData = marketingLookupType;
    filtersData = marketingLookupData;
} else {
    typeData = 'JSON'
}
...
urlRequestGrid = `${apiUrl}marketing`;
