...
if (typeof bankpelangganLookupType !== 'undefined' && typeof bankpelangganLookupData !== 'undefined') {
    typeData = bankpelangganLookupType;
    filtersData = bankpelangganLookupData;
} else {
    typeData = 'JSON'
}
...
urlRequestGrid =  `${apiUrl}bankpelanggan`;
