...
if (typeof tarifLookupType !== 'undefined' && typeof tarifLookupData !== 'undefined') {
    typeData = tarifLookupType;
    filtersData = tarifLookupData;

    if (parsePostData.jenisOrder) {
        result = filtersData.filter((word) => word.jenisorder === parsePostData.jenisOrder);
    } else {
        result = filtersData
    }
