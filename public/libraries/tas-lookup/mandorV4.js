...
if (typeof mandorLookupType !== 'undefined' && typeof mandorLookupData !== 'undefined') {
    typeData = mandorLookupType;
    filtersData = mandorLookupData; 
} else {
    typeData = 'JSON';
}
