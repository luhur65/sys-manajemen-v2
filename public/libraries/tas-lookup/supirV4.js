...
if (typeof supirLookupType !== 'undefined' && typeof supirLookupData !== 'undefined') {
    typeData = supirLookupType;
    filtersData = supirLookupData;

    if (parsePostData.supir_id && parsePostData.supir_id != '') {
        result = filtersData.filter((word) => word.id == parsePostData.supir_id);
    } else {
        result = filtersData
    }
} else {
...
filterPostData = {
    ...
    absen: parsePostData.AbsensiId || '',
    supir_id: parsePostData.supir_id || '',
    tgltrip: parsePostData.tgltrip || '',
    fromSupirSerap: parsePostData.fromSupirSerap || '',
