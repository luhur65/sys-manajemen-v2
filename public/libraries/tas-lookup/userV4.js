...
if (typeof userLookupType !== 'undefined' && typeof userLookupData !== 'undefined') {
    typeData = userLookupType;
    filtersData = userLookupData;
} else {
    typeData = 'JSON'
}

filterPostData = {
    role: parsePostData.role || '',
    isLookup: parsePostData.isLookup || true,
    tipeData: typeData
};

urlRequestGrid =  `${apiUrl}user`;
