...
var sortnameinitial = 'kodeinitial'
var idLookup = 1;
var idTop 
...
if (typeof initialLookupType !== 'undefined' && typeof initialLookupData !== 'undefined') {
    typeData = initialLookupType;
    filtersData = initialLookupData;
} else {
    typeData = 'JSON'
}
