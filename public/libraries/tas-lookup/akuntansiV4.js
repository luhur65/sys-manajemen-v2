...
if (typeof akuntansiLookupType !== 'undefined' && typeof akuntansiLookupData !== 'undefined') {
    typeData = akuntansiLookupType;
    filtersData = akuntansiLookupData;
} else {
    typeData = 'JSON'
}
...
urlRequestGrid= `${apiUrl}akuntansi`,
