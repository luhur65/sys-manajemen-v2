...
if (
    typeof jenisFakturType !== "undefined" &&
    typeof jenisFakturLookupData !== "undefined"
) {
    typeData = jenisFakturType;
    filtersData = jenisFakturLookupData;
...
// var filtersData = jenisFakturLookupData;

urlRequestGrid = `${apiUrl}jenisfaktur`;
