...
if (typeof containerLookupType !== 'undefined' && typeof containerLookupData !== 'undefined') {
    typeData = containerLookupType;
    filtersData = containerLookupData;
} else {
    typeData = 'JSON'
}
...
urlRequestGrid =  `${apiUrl}container`;
