...
if (typeof menuparentLookupType !== 'undefined' && typeof menuparentLookupData !== 'undefined') {
    typeData = menuparentLookupType;
    filtersData = menuparentLookupData;
} else {
    typeData = 'JSON'
}
...
urlRequestGrid =  `${apiUrl}menu/combomenuparent`;
