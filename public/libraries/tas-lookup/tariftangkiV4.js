...
if (typeof tariftangkiLookupType !== 'undefined' && typeof tariftangkiLookupData !== 'undefined') {
    typeData = tariftangkiLookupType;
    filtersData = tariftangkiLookupData;
} else {
    typeData = 'JSON'
}
...
urlRequestGrid= `${apiUrl}tariftangki`,
