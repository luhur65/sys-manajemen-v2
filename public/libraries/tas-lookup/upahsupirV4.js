...
if (typeof upahsupirLookupType !== 'undefined' && typeof upahsupirLookupData !== 'undefined') {
    typeData = upahsupirLookupType;
    filtersData = upahsupirLookupData;
} else {
    typeData = 'JSON'
}
...
urlRequestGrid= `${apiUrl}upahsupir`,
...
if (parsePostData.filterToolbar && typeData == 'LOCAL') {
    searchText = `.` + parsePostData.searchText;
