...
if (typeof controllerLookupType !== 'undefined' && typeof controllerLookupData !== 'undefined') {
    typeData = controllerLookupType;
    filtersData = controllerLookupData;
} else {
    typeData = 'JSON'
}
...
urlRequestGrid =  `${apiUrl}menu/controller`;
