...
if (typeof kerusakanLookupType !== 'undefined' && typeof kerusakanLookupData !== 'undefined') {
    typeData = kerusakanLookupType;
    filtersData = kerusakanLookupData;
} else {
    typeData = 'JSON'
}
...
urlRequestGrid =  `${apiUrl}kerusakan`;
