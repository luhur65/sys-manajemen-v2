...
if (typeof kelompokLookupType !== 'undefined' && typeof kelompokLookupData !== 'undefined') {
    typeData = kelompokLookupType;
    filtersData = kelompokLookupData;
} else {
    typeData = 'JSON'
}
...
urlRequestGrid =  `${apiUrl}kelompok`;
