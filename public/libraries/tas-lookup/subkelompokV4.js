...
if (typeof subkelompokLookupType !== 'undefined' && typeof subkelompokLookupData !== 'undefined') {
    typeData = subkelompokLookupType;
    filtersData = subkelompokLookupData;

    if (parsePostData.kelompok_id) {
        result = filtersData.filter((word) => word.kelompokIdForLookup == parsePostData.kelompok_id);
    } else {
        result = filtersData
    }
} else {
...
filterPostData = {
    ...
    kelompok: parsePostData.kelompok_id || '',
    forLookup: true,
    isLookup: parsePostData.isLookup || true,
    tipeData: typeData
};

urlRequestGrid= `${apiUrl}subkelompok`,
