...
if (typeof jenistradoLookupType !== 'undefined' && typeof jenistradoLookupData !== 'undefined') {
    typeData = jenistradoLookupType;
    filtersData = jenistradoLookupData;    
} else {
    typeData = 'JSON'
}
...
urlRequestGrid =  `${apiUrl}jenistrado`;
