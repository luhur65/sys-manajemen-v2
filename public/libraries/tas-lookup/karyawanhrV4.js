...
if (typeof karyawanHrLookupType !== 'undefined' && typeof karyawanHrLookupData !== 'undefined') {
    typeData = karyawanHrLookupType;
    filtersData = karyawanHrLookupData;
} else {
    typeData = 'JSON'
}
...
urlRequestGrid = `${apiUrl}user/karyawanhr`;
