...
if (typeof agenLookupType !== 'undefined' && typeof agenLookupData !== 'undefined') {
    typeData = agenLookupType;
    filtersData = agenLookupData;
} else {
    typeData = 'JSON'
}
...
urlRequestGrid = `${apiUrl}customer`;
