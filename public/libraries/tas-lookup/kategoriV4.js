...
if (typeof kategoriLookupType !== 'undefined' && typeof kategoriLookupData !== 'undefined') {
    typeData = kategoriLookupType;
    filtersData = kategoriLookupData;

    if (parsePostData.subkelompok_id) {
        result = filtersData.filter((word) => word.subkelompok_id == parsePostData.subkelompok_id);
    } else {
        result = filtersData
    }    
} else {
...
filterPostData = {
    ...
    subkelompok: parsePostData.subkelompok_id || '',
    forLookup: true,
    isLookup: parsePostData.isLookup || true,
    tipeData: typeData
};

urlRequestGrid= `${apiUrl}kategori`,
