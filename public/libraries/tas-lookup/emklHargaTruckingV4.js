...
if (typeof satuanLookupType !== 'undefined' && typeof satuanLookupData !== 'undefined') {
    typeData = satuanLookupType;
    filtersData = satuanLookupData; 
} else {
    typeData = 'JSON';
}
...
filterPostData = {
    ...
    cabangasal: parsePostData.cabangasal,
    tujuankapal: parsePostData.tujuankapal,
    forLookup: true,
    isLookup: parsePostData.isLookup || true,
    tipeData: typeData
};

urlRequestGrid = `${apiUrl}tarifemkl/hargatrucking`;
