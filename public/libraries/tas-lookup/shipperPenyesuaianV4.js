...
var sortnameshipper = 'penyesuaian'
var idLookup = 1;
var idTop
...
if (typeof shipperPenyesuaianLookupType !== 'undefined' && typeof shipperPenyesuaianLookupData !== 'undefined') {
    typeData = shipperPenyesuaianLookupType;
    filtersData = shipperPenyesuaianLookupData;
} else {
    typeData = 'JSON'
}
...
urlRequestGrid = `${apiUrl}shipperpenyesuaian`,
