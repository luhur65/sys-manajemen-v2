...
if (typeof shipperEmklLookupType !== 'undefined' && typeof shipperEmklLookupData !== 'undefined') {
    typeData = shipperEmklLookupType;
    filtersData = shipperEmklLookupData;
} else {
    typeData = 'JSON'
}
...
urlRequestGrid = `${apiUrl}shipperemkl`,
