...
if (typeof karyawanLookupType !== 'undefined' && typeof karyawanLookupData !== 'undefined') {
    typeData = karyawanLookupType;
    filtersData = karyawanLookupData;
} else {
    typeData = 'JSON'
}
...
filterPostData = {
    ...
    staff: parsePostData.staff || '',
    isLookup: parsePostData.isLookup || true,
    tipeData: typeData
};

urlRequestGrid =  `${apiUrl}karyawan`;
