...
if (typeof pengeluarantruckingLookupType !== 'undefined' && typeof pengeluarantruckingLookupData !== 'undefined') {
    typeData = pengeluarantruckingLookupType;
    filtersData = pengeluarantruckingLookupData;    
} else {;
    typeData = 'JSON'
}
...
urlRequestGrid =  `${apiUrl}pengeluarantrucking`;
