...
if (typeof typeakuntansiLookupType !== 'undefined' && typeof typeakuntansiLookupData !== 'undefined') {
    typeData = typeakuntansiLookupType;
    filtersData = typeakuntansiLookupData; 
} else {
    typeData = 'JSON';
}
...
urlRequestGrid = `${apiUrl}typeakuntansi`;
