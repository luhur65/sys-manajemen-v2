...
if (typeof penerimaanstokLookupType !== 'undefined' && typeof penerimaanstokLookupData !== 'undefined') {
    typeData = penerimaanstokLookupType;
    filtersData = penerimaanstokLookupData;
} else {
    typeData = 'JSON'
}
...
urlRequestGrid =  `${apiUrl}penerimaanstok`;
