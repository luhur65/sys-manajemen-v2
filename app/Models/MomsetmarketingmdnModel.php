...
class MomsetmarketingmdnModel extends Model
{
    protected $dbtruck;
    protected $table      = 'OmsetMarketingMdn';
    ...
    public function count($where)
    {
        ...
        $sql = $this->dbtruck->query("SELECT FTgl FROM OmsetMarketingMdn $whereClause");
        return $sql;
    }
    ...
    public function getGrandTotal($where)
    {
        ...
        $sql = $this->dbtruck->query("SELECT 
            ...
            FROM OmsetMarketingMdn $whereClause");
        return $sql->getRow();
    }
    
    public function get_tglupdate()
    {
        $sql = $this->dbtruck->query("SELECT MAX(FTglUpdate) as FlastUpdate FROM OmsetMarketingMdn");
