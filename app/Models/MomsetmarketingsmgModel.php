...
class MomsetmarketingsmgModel extends Model
{
    protected $dbtruck;
    protected $table      = 'OmsetMarketingSmg';
    ...
    public function count($where)
    {
        ...
        $sql = $this->dbtruck->query("SELECT FTgl FROM OmsetMarketingSmg $whereClause");
        return $sql;
    }
    ...
    public function getGrandTotal($where)
    {
        ...
        $sql = $this->dbtruck->query("SELECT 
            ...
            FROM OmsetMarketingSmg $whereClause");
        return $sql->getRow();
    }
    
    public function get_tglupdate()
    {
        $sql = $this->dbtruck->query("SELECT MAX(FTglUpdate) as FlastUpdate FROM OmsetMarketingSmg");
