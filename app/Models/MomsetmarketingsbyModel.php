...
class MomsetmarketingsbyModel extends Model
{
    protected $dbtruck;
    protected $table      = 'OmsetMarketingSby';
    ...
    public function count($where)
    {
        ...
        $sql = $this->dbtruck->query("SELECT FTgl FROM OmsetMarketingSby $whereClause");
        return $sql;
    }
    ...
    public function getGrandTotal($where)
    {
        ...
        $sql = $this->dbtruck->query("SELECT 
            ...
            FROM OmsetMarketingSby $whereClause");
        return $sql->getRow();
    }
    
    public function get_tglupdate()
    {
        $sql = $this->dbtruck->query("SELECT MAX(FTglUpdate) as FlastUpdate FROM OmsetMarketingSby");
