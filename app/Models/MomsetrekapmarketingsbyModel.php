...
class MomsetrekapmarketingsbyModel extends Model
{
    protected $dbtruck;
    protected $table      = 'vRekapOmsetMarketingSby';
    ...
    public function count($where)
    {
        ...
        $sql = $this->dbtruck->query("SELECT FBulan FROM vRekapOmsetMarketingSby $whereClause");
        return $sql;
    }
    ...
    public function getGrandTotal($where)
    {
        ...
        $sql = $this->dbtruck->query("SELECT 
            ...
            FROM vRekapOmsetMarketingSby $whereClause");
        return $sql->getRow();
    }
    
    public function get_tglupdate()
    {
        $sql = $this->dbtruck->query("SELECT MAX(FTglUpdate) as FlastUpdate FROM vRekapOmsetMarketingSby");
