...
class MomsetmarketingbtgModel extends Model
{
    protected $dbtruck;
    protected $table      = 'OmsetMarketingBtg';
    ...
    public function count($where)
    {
        ...
        $sql = $this->dbtruck->query("SELECT FTgl FROM OmsetMarketingBtg $whereClause");
        return $sql;
    }
    ...
    public function getGrandTotal($where)
    {
        ...
        $sql = $this->dbtruck->query("SELECT 
            ...
            FROM OmsetMarketingBtg $whereClause");
        return $sql->getRow();
    }
    
    public function get_tglupdate()
    {
        $sql = $this->dbtruck->query("SELECT MAX(FTglUpdate) as FlastUpdate FROM OmsetMarketingBtg");
