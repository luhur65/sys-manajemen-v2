...
class MomsetrekapmarketingmksModel extends Model
{
    protected $dbtruck;
    protected $table      = 'vRekapOmsetMarketingMks';
    ...
    public function count($where)
    {
        ...
        $sql = $this->dbtruck->query("SELECT FBulan FROM vRekapOmsetMarketingMks $whereClause");
        return $sql;
    }
    ...
    public function getGrandTotal($where)
    {
        ...
        $sql = $this->dbtruck->query("SELECT 
            ...
            FROM vRekapOmsetMarketingMks $whereClause");
        return $sql->getRow();
    }
    
    public function get_tglupdate()
    {
        $sql = $this->dbtruck->query("SELECT MAX(FTglUpdate) as FlastUpdate FROM vRekapOmsetMarketingMks");
