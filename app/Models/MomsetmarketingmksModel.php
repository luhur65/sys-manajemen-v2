...
{
    protected $dbtruck;
    protected $table      = 'OmsetMarketingMks';
    ...
    public function count($where)
    {
        ...
        $sql = $this->dbtruck->query("SELECT FTgl FROM OmsetMarketingMks $whereClause");
        return $sql;
    }
    ...
    public function getGrandTotal($where)
    {
        ...
        $sql = $this->dbtruck->query("SELECT 
            ...
            FROM OmsetMarketingMks $whereClause");
        return $sql->getRow();
    }
    
    public function get_tglupdate()
    {
        $sql = $this->dbtruck->query("SELECT MAX(FTglUpdate) as FlastUpdate FROM OmsetMarketingMks");
