...
class MomsetrekapmarketingmdnModel extends Model
{
    protected $dbtruck;
    protected $table      = 'vRekapOmsetMarketing';
    ...
    public function count($where)
    {
        ...
        $sql = $this->dbtruck->query("SELECT FBulan FROM vRekapOmsetMarketing $whereClause");
        return $sql;
    }
    ...
    public function getGrandTotal($where)
    {
        ...
        $sql = $this->dbtruck->query("SELECT 
            ...
            FROM vRekapOmsetMarketing $whereClause");
        return $sql->getRow();
    }
    
    public function get_tglupdate()
    {
        $sql = $this->dbtruck->query("SELECT MAX(FTglUpdate) as FlastUpdate FROM vRekapOmsetMarketing");
