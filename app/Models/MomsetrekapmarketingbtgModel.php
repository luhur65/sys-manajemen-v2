...
class MomsetrekapmarketingbtgModel extends Model
{
    protected $dbtruck;
    protected $table      = 'vRekapOmsetMarketingBtg';
    ...
    public function count($where)
    {
        ...
        $sql = $this->dbtruck->query("SELECT FBulan FROM vRekapOmsetMarketingBtg $whereClause");
        return $sql;
    }
    ...
    public function getGrandTotal($where)
    {
        ...
        $sql = $this->dbtruck->query("SELECT 
            ...
            FROM vRekapOmsetMarketingBtg $whereClause");
        return $sql->getRow();
    }
    
    public function get_tglupdate()
    {
        $sql = $this->dbtruck->query("SELECT MAX(FTglUpdate) as FlastUpdate FROM vRekapOmsetMarketingBtg");
