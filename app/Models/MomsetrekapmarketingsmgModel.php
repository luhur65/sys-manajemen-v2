...
class MomsetrekapmarketingsmgModel extends Model
{
    protected $dbtruck;
    protected $table      = 'vRekapOmsetMarketingSmg';
    ...
    public function count($where)
    {
        ...
        $sql = $this->dbtruck->query("SELECT FBulan FROM vRekapOmsetMarketingSmg $whereClause");
        return $sql;
    }
    ...
    public function getGrandTotal($where)
    {
        ...
        $sql = $this->dbtruck->query("SELECT 
            ...
            FROM vRekapOmsetMarketingSmg $whereClause");
        return $sql->getRow();
    }
    
    public function get_tglupdate()
    {
        $sql = $this->dbtruck->query("SELECT MAX(FTglUpdate) as FlastUpdate FROM vRekapOmsetMarketingSmg");
