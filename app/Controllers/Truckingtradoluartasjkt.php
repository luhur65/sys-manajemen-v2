...
class Truckingtradoluartasjkt extends BaseController
{
    protected $model;
    ...
    public function index()
    {
        ...
        $data = [
            'title' => 'Penggunaan Trado Luar TAS Per Bulan (JKT)',
            'menuaktif' => 'Laporan Trucking',
            'comboBulan' => $htmlComboBulan,
            'comboJenisTrado' => $htmlComboJenisTrado,
        ];
        
        return $this->render('truckingtradoluartasjkt/index', $data);
    }
