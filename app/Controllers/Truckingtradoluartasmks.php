...
class Truckingtradoluartasmks extends BaseController
{
    protected $model;
    ...
    public function index()
    {
        ...
        $data = [
            'title' => 'Penggunaan Trado Luar TAS Per Bulan (MKS)',
            'menuaktif' => 'Laporan Trucking',
            'comboBulan' => $htmlComboBulan,
            'comboJenisTrado' => $htmlComboJenisTrado,
        ];
        
        return $this->render('truckingtradoluartasmks/index', $data);
    }
