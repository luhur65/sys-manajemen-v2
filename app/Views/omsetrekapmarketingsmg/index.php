<style>
    ...
    /* YearPicker styling fix */
    /* .year-picker { background: #fff; border: 1px solid #ccc; padding: 10px; box-shadow: 0px 4px 6px rgba(0,0,0,0.1); }
    .month-picker-month-table td { text-align: center; padding: 2px; }
    .month-picker-month-table a { padding: 5px 10px; display: block; cursor: pointer; text-decoration: none; color: #f3f3f3ff; }
    .month-picker-month-table a:hover { background: #007bff; color: white; border-radius: 4px; }
    .month-picker-month-table a.ui-state-active { background: #e0e4e9ff; color: white; border-radius: 4px; font-weight: bold;}
    .month-picker-header { text-align: center; margin-bottom: 5px; font-weight: bold; }
    .month-picker-year-table { width: 100%; } */
    
    /* Dark Mode styling */
    /* body.dark-mode .year-picker { background: #343a40; border-color: #6c757d; color: #fff; }
    body.dark-mode .month-picker-month-table a { color: #fff; }
    body.dark-mode .month-picker-month-table a:hover { background: #454d55; color: #fff; }
    body.dark-mode .month-picker-month-table a.ui-state-active { background: #007bff; color: #fff; }
    body.dark-mode .month-picker-header { color: #fff; background: transparent; }
    
    body.dark-mode .ui-datepicker { background: #343a40 !important; border: 1px solid #6c757d; color: #fff; }
    body.dark-mode .ui-datepicker .ui-datepicker-header { background: #343a40 !important; color: #fff !important; border-bottom: 1px solid #6c757d; }
    body.dark-mode .ui-datepicker .ui-state-default { background: #343a40 !important; color: #fff !important; border: 1px solid #6c757d !important; }
    body.dark-mode .ui-datepicker .ui-state-hover { background: #454d55 !important; color: #fff !important; }
    body.dark-mode .ui-datepicker .ui-state-active { background: #007bff !important; color: #fff !important; }
    body.dark-mode .ui-widget-content { background: #343a40; color: #fff; }
    body.dark-mode .ui-widget-header a { color: #fff; } */
</style>
    ...
    <div class="card card-primary card-outline">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">DATA REKAP OMSET MARKETING - CABANG SEMARANG</h3>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        let sortorder = 'desc';
        let rowNum = 50;
        const apiUrl = `<?= base_url('omsetrekapmarketingsmg/grid') ?>`;
        const comboUrl = `<?= base_url('omsetrekapmarketingsmg/combomarketing') ?>`;
        const $grid = $("#jqGrid");
