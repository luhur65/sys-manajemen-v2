    ...
    <div class="card card-primary card-outline">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">DATA REKAP OMSET MARKETING - CABANG MAKASSAR</h3>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        let sortorder = 'desc';
        let rowNum = 50;
        const apiUrl = `<?= base_url('omsetrekapmarketingmks/grid') ?>`;
        const comboUrl = `<?= base_url('omsetrekapmarketingmks/combomarketing') ?>`;
        const $grid = $("#jqGrid");
